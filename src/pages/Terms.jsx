      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-md p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-700">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">4. Age-Restricted Communities (HOPA)</h2>
              <p>
                RentDirect55 lists properties in age-restricted 55+ communities that operate under the
                Housing for Older Persons Act (HOPA). Under HOPA, these communities are legally permitted
                to restrict residency to persons 55 years of age or older. This age restriction is not
                discrimination under the Fair Housing Act.
              </p>
              <p className="mt-3">
                By using this Service to find rental properties, you acknowledge that:
              </p>
              <ul className="list-disc pl-6 mt-3 space-y-2">
                <li>Properties listed may have age restrictions requiring at least one occupant to be 55 or older</li>
                <li>Individual communities may have additional residency requirements</li>
                <li>You are responsible for verifying eligibility requirements with the property owner and community</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">5. Disclaimer of Warranties</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">6. Limitation of Liability</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">7. Indemnification</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">8. Fair Housing</h2>
              <p>
                ...
                religion, sex, national origin, familial status (except as permitted under HOPA for
                age-restricted communities), or disability is prohibited.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">9. Content Removal</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">10. Trademark Notice</h2>
              <p>
                RentDirect55 is an independent listing service and is not affiliated with, endorsed by,
                or sponsored by any of the communities listed on this platform. Community names mentioned
                on this site, including but not limited to The Villages®, Sun City®, Del Webb®, and others,
                are registered trademarks of their respective owners. All trademarks, service marks, and
                trade names are the property of their respective owners.
              </p>
            </section>

            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">11. Changes to Terms</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-4 font-display">12. Contact</h2>
              <p>
